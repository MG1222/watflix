...
const Home = () => {
    ...
    const movies = [
        {   title:"Harry Potter",
            img:"https://resize-parismalltch.lanmedia.fr/var/pm/public/media/image/2022/02/28/18/Harry-Potter-ne-depose-pas-les-charmes.jpg?VersionId=WlNYB2ROPwFGXk20V3fFwDVl4Z3m8.T9",
        ...
        {title:"Avatar", img:"https://www.onefm.ch/wp-content/uploads/2022/07/718285-avatar-2-a-enfin-sa-date-de-sor123tie-en-france.jpg", descriptionShort:"Rencontre avec les Na'vi de Pandora"},
        ...
        {title:"Star Wars", img:"", descriptionShort:"Les aventures des utilisateurs de la force"},
        {   title:"Harry Potter",
